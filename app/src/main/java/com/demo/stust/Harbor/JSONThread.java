        ...
        public void run(){
            ...
            try {
                for (int i=0 ; i<4 ; i++){
                    ...
                    if ( str_Rain.equals("The page cannot be displayed because an internal server error has occurred.") ) {
                        Log.i(TAG,"Server Broken");
                        break;
                    }
                }
                sbAPIText = new StringBuilder();
                if (apiData != null && !apiData.get(0).equals("The page cannot be displayed because an internal server error has occurred.") ) {
                    Log.i(TAG, "\n" + "API Data：" + "\n" + apiData.get(0) + "\n" + apiData.get(1) + "\n" + apiData.get(2) + "\n" + apiData.get(3));
                    ...
                    sbAPIText.setLength(0);
                    sbAPIText.append("Sorry , Server problems");
                    handler.post(ChangeText);
                }
